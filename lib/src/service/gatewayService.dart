...
class GatewayService {
  Future<List<TransactionModel>> fetchPayment() async {
    ...
    String body =
        '{"merchant": "1ab41be0-fb97-46a4-b1b0-df5b851f247d", "dateStart": "2020-05-01", "dateEnd": "2020-05-21", "status":2}';
  ...
  List<TransactionModel> parseTransaction(String responseBody) {
