class Value {
  ...
  factory Value.fromJson(Map<String, dynamic> json) => Value(
        ...
        codigoDeBarras:  json["codigoDeBarras"] != null ? json["codigoDeBarras"] : '',
        desconto: json["desconto"],
        juros: json["juros"],
        linhaDigitavel: json["linhaDigitavel"],
        motivo: json["motivo"],
        multa: json["multa"],
        nomeBeneficiario: json["nomeBeneficiario"] != null ? json["nomeBeneficiario"] : '',
        nomePagador: json["nomePagador"] != null ? json["nomePagador"] : '',
        ...
        valorTotal:  json["valorTotal"] != null ? json["valorTotal"].toDouble() : 0.0,
        dataVencimento:  json["dataVencimento"] != null ? DateTime.parse(json["dataVencimento"]) : '',
